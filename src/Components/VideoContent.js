    ...
    <div className='video-content'>
      <div className='iframe-container'>
        ...
        {/*Below is a bit of a 'hack.' We get a placeholder image to be scaled along the inside of the iframe container based on the window size.
           This allows us to essentially attach the video to that image, making the iframe video responsive without having
           to define set heights and widths to the video component
        */}
        <img className='ratio' src='http://placehold.it/16x9' alt='Placeholder for resizing video. Ignore this!'/>
